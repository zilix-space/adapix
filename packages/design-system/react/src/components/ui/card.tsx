...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'flex flex-col space-y-1.5 p-6 animate-fade-up animate-delay-200 animate-once animate-ease-in-out',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'p-6 pt-0 animate-fade-up animate-delay-300 animate-once animate-ease-in-out',
      className,
    )}
    {...props}
  />
...
CardFooter.displayName = 'CardIcon'
